<div class="row">
    <p class="strong col-md-12 uppercase text-center git-table">Relacionados con el <span class="underline">Geo-Desarrollo</span></p>
</div>
...
<div class="row">
    <table class="table text-center table-hover mb1">
        <thead>
        <tr>
    ...
    <div class="form-group pt0 col-md-6">
        ...
        <div id="input-container">
            ...
            <span class="input-group-btn pull-left">
                <button class="btn btn-primary addSkill" type="button"  data-target="#geoskill" data-isgis="true" data-table="#geoSkillTable"><i class="fa fa-plus disabled"></i></button>
            </span>
            </div>
        </div>
    </div>
    <div class="form-group pt0 col-md-6">
        ...
        <div id="input-container">
            <div class="input-group skillList" id="skillList">
                ...
                <span class="input-group-btn pull-left">
                    <button class="btn btn-primary" type="button" data-target="#geoskill" data-input="#inputGeoSkill"><i class="fa fa-plus disabled"></i></button>
                </span>
            </div>
        </div>
    </div>
...
<div class="row">
    ...
    <p class="strong col-md-12 uppercase text-center other-table">Otros:</p>
</div>
...
{else}
    <div class="row">
        <table class="table text-center table-hover">
            ...
            <tbody class="skills small" id="skillTable">
        ...
        <div class="form-group pt0 col-md-6">
            ...
            <div id="input-container">
                <div class="input-group">
                    ...
                    <span class="input-group-btn pull-left">
                        <button class="btn btn-success addSkill" type="button" data-target="#skill" data-isgis="false" data-table="#skillTable"><i class="fa fa-plus disabled"></i></button>
                    </span>
                </div>
            </div>
        </div>
        <div class="form-group pt0 col-md-6">
            ¿Necesitas inspiración?, ten un listado:
            <div id="input-container">
                <div class="input-group skillList">
                    <select class="form-control pull-left" id="inputOtherSkill">
                        {for $I=0 to $OTHERSKILLS|@count-1}<option>{$OTHERSKILLS[$I]["name"]}</option>{/for}
                    </select>
                <span class="input-group-btn pull-left">
                    <button class="btn btn-success" type="button" data-target="#skill" data-input="#inputOtherSkill"><i class="fa fa-plus disabled"></i></button>
                </span>
                </div>
            </div>
        </div>
...
var OTHERSKILLS = [{for $I=0 to $OTHERSKILLS|@count-1}"{$OTHERSKILLS[$I]["name"]}",{/for}];
{literal}</script>{/literal}
